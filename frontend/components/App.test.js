...
describe('Module 4 Project Tests', () => {
  describe('English Language', () => {
    ...
    */
    ...
    test(`LABEL_FAV_FOOD is visible`, () => {
      render(<App lang='en' />)
      expect(screen.getByLabelText(txt.en.LABEL_FAV_FOOD))
    })
    test(`LABEL_ACCEPT_TERMS is visible`, () => {
      render(<App lang='en' />)
      expect(screen.getByLabelText(txt.en.LABEL_ACCEPT_TERMS))
    })
    test(`PLACEHOLDER_USERNAME is visible`, () => {
      render(<App lang='en' />)
      expect(screen.getByPlaceholderText(txt.en.PLACEHOLDER_USERNAME))
    })
  })
  describe('Spanish Language', () => {
    ...
    */
      ...
      test(`LABEL_FAV_FOOD is visible`, () => {
        render(<App lang='esp' />)
        expect(screen.getByLabelText(txt.esp.LABEL_FAV_FOOD))
      })
      test(`LABEL_ACCEPT_TERMS is visible`, () => {
        render(<App lang='esp' />)
        expect(screen.getByLabelText(txt.esp.LABEL_ACCEPT_TERMS))
      })
      test(`PLACEHOLDER_USERNAME is visible`, () => {
        render(<App lang='esp' />)
        expect(screen.getByPlaceholderText(txt.esp.PLACEHOLDER_USERNAME))
      })
    })
